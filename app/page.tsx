              ...
              return (
                ...
                >
                  ...
                  <div className="flex gap-0.5 min-h-[6px] items-center justify-center">
                    {allDone && <div className="w-1.5 h-1.5 rounded-full bg-green-400" />}
                    ...
                    {!allDone && pendingCount > 0 && <div className="w-1.5 h-1.5 rounded-full" style={{ backgroundColor: isSelected ? 'rgba(255,255,255,0.5)' : '#d1d5db' }} />}
                  </div>
                </button>
              )
            })}
